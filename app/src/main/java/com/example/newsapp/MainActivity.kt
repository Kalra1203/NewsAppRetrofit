...
import com.example.newsapp.room.SavedNewsComp
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        val viewModelRoom by viewModels<TopHeadlinesViewModelRoom>()
            ...
            NewsAppTheme {
                ...
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = "first") {
                        ...
                        composable("second") {
                            SavedNewsComp(topHeadlinesViewModelRoom = viewModelRoom)
                        }
